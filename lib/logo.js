...
class LogoGenerator {
  ...
  generateSVG() {
    ...
    case "square":
        ...
        break;
        case "pyramid":
            svg += `<polygon points="150,20 250,100 200,180 100,180" fill="${this.shapeColor}" />`;
            break;
            
            case "star":
                svg += `<polygon points="150,20 180,80 250,90 200,130 220,190 150,160 80,190 100,130 50,90 120,80" fill="${this.shapeColor}" />`;
                break;
    default:
            break;
    }
